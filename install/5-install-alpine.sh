...
apk fetch xorg-server xf86-input-libinput xinit eudev mesa-dri-gallium doas sudo font-terminus lightdm lightdm-gtk-greeter xfce4-terminal awesome wireplumber pipewire-pulse pipewire-alsa pavucontrol thunar thunar-archive-plugin imagemagick rofi picom xautolock polkit-gnome i3lock-color hd-idle feh git &&

apk --allow-untrusted -U --root /mnt/newroot --initdb add \
xorg-server xf86-input-libinput xinit eudev mesa-dri-gallium doas sudo font-terminus lightdm lightdm-gtk-greeter xfce4-terminal awesome wireplumber pipewire-pulse pipewire-alsa pavucontrol thunar thunar-archive-plugin imagemagick rofi picom xautolock polkit-gnome i3lock-color hd-idle feh git &&
